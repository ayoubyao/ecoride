          ...
          >
            ...
            <div className="flex flex-col gap-1 text-sm">
              <div>
                ...
                {formatDateTime(trajet.date_depart)} {trajet.heure_depart}
              </div>
              <div>
                <span className="font-semibold">Arrivée :</span>{" "}
                {formatDateTime(trajet.date_arrivee)} {trajet.heure_arrivee}
              </div>
            </div>

            <div className="flex justify-between text-sm text-gray-600 mt-2">
              <p>
                <strong>Places :</strong> {trajet.nb_place}
              </p>
              <p>
                <strong>Prix :</strong> {trajet.prix_personne} €
              </p>
            </div>
            ...
            <button
              onClick={() => navigate(`/covoiturage/${trajet.covoiturage_id}`)}
              className="mt-auto self-end px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition"
            >
              Détails
            </button>
          </div>
